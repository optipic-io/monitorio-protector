...
class BootstrapMy
{
     ...
     * @return void
     */
    public function __construct(string $storage = '', string $panelUrl = '/firewall/panel/', string $requestUri = '')
    {   
    ...
    public function run(): void
    {
        ...
        //var_dump($USER->GetLogin());exit;
        $bxUsername = $USER->GetLogin();
        
        get_session_instance()->set('site_username', $bxUsername);
