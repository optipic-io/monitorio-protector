...
return [
    ...
    'ipma_description' => 'IP Менеджер не похож на "Временные IP Правила" (Временные правила актуальны лишь в рамках текущего жизненного цикла). <br>Все правила "IP Менеджера", которые вы здесь добавите, являтся постоянными.',
    'ipma_label_ip' => 'IP',
